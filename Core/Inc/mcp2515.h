...
static uint32_t DEFAULT_SPI_CLOCK = 10000000; // 10MHz
...
enum ERROR setBitrate(const enum CAN_SPEED canSpeed, const enum CAN_CLOCK canClock);
enum ERROR setFilterMask(const enum MASK num, const bool ext, const uint32_t ulData);
